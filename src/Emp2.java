...
class Employee3{
  ...
  public Employee3(String n, int y, int sal, String add){
    name = n;
    year = y;
    salary = sal;
    address = add;
...
class Emp2{
  public static void main(String[] args){
    Employee3 e1 = new Employee3("Robert", 1994, 500000, "64C- WallsStreet");
    Employee3 e2 = new Employee3("Sam", 2000, 740000, "68d- WallsStreet");
    Employee3 e3 = new Employee3("John", 1999, 600000, "26B- WallsStreet");
