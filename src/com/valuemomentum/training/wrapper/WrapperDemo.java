...
public class WrapperDemo {
	...
	public static void main(String[] args) {
          ...
          System.out.println(Character.isUpperCase(e)); 	//check uppercase or not
          
          
          double d=250.5;
          Double obj5=new Double(d); 						 //wrapper class
          System.out.println(obj5);
          System.out.println(obj5.toHexString(d)); 			//coverting to hexadecimal
