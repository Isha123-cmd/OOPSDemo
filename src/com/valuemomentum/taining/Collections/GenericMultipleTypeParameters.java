...
class Employee10
{
	...
	{
		public K getKey();
		public V getValue();   //return type of methods are K,V
	}
...
public class GenericMultipleTypeParameters {
	...
	public static void main(String[] args) {
		...
		OrderedPair<Integer,String> op1=new OrderedPair<Integer,String>(101,"java");
            ...
            OrderedPair<String,String> op2=new OrderedPair<String,String>("isha","java");
            System.out.println(op2.getKey() + ":" +op2.getValue());
            
           // OrderedPair<Integer,Employee10> op3=new OrderedPair<Integer,Employee10>(10, new Employee("abcd"));
